...
public class QuestionController {
    ...
    // Get all Essay questions by quiz ID
    @GetMapping("/quiz/{quizId}/essay")
    public ResponseEntity<List<EssayQuestion>> getEssayQuestionsByQuizId(@PathVariable Long quizId) {
        List<EssayQuestion> questions = questionService.getEssayQuestionsByQuizId(quizId);
        return new ResponseEntity<>(questions, HttpStatus.OK);
    }
