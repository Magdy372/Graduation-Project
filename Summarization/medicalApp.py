...
class MedicalSummarizer:
    ...
    #state_dict = load_file("medical_lecture_summarizer/model.safetensors")

    # Save as PyTorch bin
    #torch.save(state_dict, "medical_lecture_summarizer/pytorch_model.bin")
    
    model_path = "./medical_lecture_summarizer"  # Adjust if needed
    ...
    def generate_summary(self, text: str) -> str:
        ...
        try:
            ...
            summary_ids = self.model.generate(          
                ...
                length_penalty=1.2,           
                min_length=300,                 
                max_length=600,   # Adjusted to match training            
                early_stopping=True,
